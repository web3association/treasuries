...
* Soulbound tokens - Tokens that are issued and designated to a single individual or entity and are not transferrable.
* Privacy tokens - A token could wrap an existing coin from a public chain and making the transactions private.
